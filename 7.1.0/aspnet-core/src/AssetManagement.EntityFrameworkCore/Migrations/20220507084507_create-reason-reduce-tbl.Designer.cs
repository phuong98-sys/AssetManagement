...
namespace AssetManagement.Migrations
{
    ...
    [Migration("20220507084507_create-reason-reduce-tbl")]
    partial class createreasonreducetbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagement.Assets.Asset", b =>
                {
                    ...
                    b.Property<int>("ReasonReductionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetManagement.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AssetManagement.Departments.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DeartmentName")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
            ...
            modelBuilder.Entity("AssetManagement.ProposeAssets.ProposeAsset", b =>
                {
                    ...
                    b.Property<string>("NumbersProposeAsset")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("Proponent")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AssetManagement.ReasonReductions.ReasonReduction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReasonReductionCode")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("ReasonReductionName")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
            ...
            modelBuilder.Entity("AssetManagement.SuggestionHandlingDetails.SuggestionHandlingDetail", b =>
                {
                    ...
                    b.Property<int?>("SuggestionHandlingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SuggestionHandlingId");

                    b.ToTable("SuggestionHandlingDetail");
                });

            modelBuilder.Entity("AssetManagement.SuggestionHandlings.SuggestionHandling", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("SuggestionHandlingDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("SuggestionHandlingName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WS.PropertyTypes.PropertyType", b =>
                {
                    ...
                    b.Property<string>("ParentPropertyTypeId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AssetManagement.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AssetManagement.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AssetManagement.Assets.Asset", b =>
                {
                    ...
                    b.HasOne("AssetManagement.ReasonReductions.ReasonReduction", "ReasonReduction")
                        .WithMany()
                        .HasForeignKey("ReasonReductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AssetManagement.Authorization.Roles.Role", b =>
                {
                    b.HasOne("AssetManagement.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("AssetManagement.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("AssetManagement.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AssetManagement.ReasonReductions.ReasonReduction", b =>
                {
                    b.HasOne("AssetManagement.IncreaseAssets.IncreaseAsset", null)
                        .WithMany("ReasconReductions")
                        .HasForeignKey("IncreaseAssetId");
                });
            ...
            modelBuilder.Entity("AssetManagement.SuggestionHandlingDetails.SuggestionHandlingDetail", b =>
                {
                    ...
                    b.HasOne("AssetManagement.SuggestionHandlings.SuggestionHandling", "SuggestionHandling")
                        .WithMany()
                        .HasForeignKey("SuggestionHandlingId");

                    b.Navigation("Asset");

                    b.Navigation("SuggestionHandling");
                });
            ...
            modelBuilder.Entity("AssetManagement.IncreaseAssets.IncreaseAsset", b =>
                {
                    ...
                    b.Navigation("ReasconReductions");
                });
