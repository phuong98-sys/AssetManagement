...
@Component({
  selector: 'app-add-asset-plane-shop',
  templateUrl: './add-asset-plane-shop.component.html',
  styleUrls: ['./add-asset-plane-shop.component.css']
})
export class AddAssetPlaneShopComponent  extends  AppComponentBase implements OnInit {
