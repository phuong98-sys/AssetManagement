...
namespace WS.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : WSServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("WS", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
