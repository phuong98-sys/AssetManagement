...
using WS.Web.Authentication.JwtBearer;
using WS.Web.Authentication.TwoFactor;
using WS.Web.Configuration;
#if FEATURE_SIGNALR
...
namespace WS.Web
{
    ...
    public class WSWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public WSWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(WSApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(WSWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(WSWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
