...
namespace WS.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "WS API", Version = "v1" });
            ...
            return services.AddAbp<WSWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "WS API V1");
            }); //URL: /swagger
        }
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            app.Properties["host.AppName"] = "WS";
