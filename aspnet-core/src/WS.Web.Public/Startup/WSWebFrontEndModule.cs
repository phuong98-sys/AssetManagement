...
namespace WS.Web.Public.Startup
{
    [DependsOn(
        typeof(WSWebCoreModule)
    )]
    public class WSWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public WSWebFrontEndModule(IHostingEnvironment env, WSEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(WSWebFrontEndModule).GetAssembly());
        }
    }
}
